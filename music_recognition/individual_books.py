...
class IndividualBookGenerator:
    ...
    def split_combined_parts(self, multipart_score: MultiPartScore) -> Dict[str, Tuple[MusicScore, InstrumentConfig]]:
        """
        Split combined parts in a MultiPartScore into individual parts.
    ...
    def export_individual_books(self, multipart_score: MultiPartScore,
                               output_dir: str,
                               clean_titles: bool = True) -> Dict[str, str]:
        """
        ...
        individual_parts = self.split_combined_parts(multipart_score)
...
def create_individual_books_from_score(multipart_score: MultiPartScore,
                                       output_dir: str = 'output/individual_books') -> Dict[str, str]:
    """
    ...
    Example:
        ...
        >>> books = create_individual_books_from_score(score)
        >>> # Results in separate PDFs for each instrument
    """
    generator = IndividualBookGenerator()
    return generator.export_individual_books(multipart_score, output_dir)
